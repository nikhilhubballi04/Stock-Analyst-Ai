...
def generate_report(ticker: str, latest_close: float, predicted_price: float,
                     ...
                     xgb_mape: float, rsi: float, macd_signal: str) -> str:

    # Compute the comparison in code, not in the LLM's "head"
...
- Model-predicted next price: ${predicted_price}
...
1. States the current price and the model's predicted move
